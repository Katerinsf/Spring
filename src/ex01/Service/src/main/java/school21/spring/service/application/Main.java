...
public class Main {
    public static void main(String[] args) {
        ...
        User user1 = new User("Cat@gmail.com");
        User user2 = new User("pAnda@list.ru");
        User user3 = new User("raT@yandex.ru");
        User user4 = new User("dOg@mail.ru");
        ...
        Optional<User> userEmail = usersRepository.findByEmail("Cat@gmail.com");
        ...
        System.out.println("-----Method findByEmail------");
        userEmail = usersRepository.findByEmail("dOg@mail.ru");
        if(userEmail.isPresent()) {
            System.out.println(userEmail.get());
        } else {
            System.err.println("User with this Email not found");
